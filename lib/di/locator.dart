...
void setupLocator(SharedPreferences sharedPreferences) {
  ...
  locator.registerLazySingleton<CalendarRepository>(
    () => CalendarRepositoryImpl(
      localDataSource: locator<CalendarLocalDataSource>(),
    ),
  );
  ...
  locator.registerLazySingleton<PrayerAlarmLocalDataSource>(
    () => PrayerAlarmLocalDataSourceImpl(
      sharedPreferences: locator<SharedPreferences>(),
    ),
  );
  locator.registerLazySingleton<PrayerAlarmRepository>(
    () => PrayerAlarmRepositoryImpl(
      localDataSource: locator<PrayerAlarmLocalDataSource>(),
    ),
  );
  locator.registerLazySingleton<PrayerAlarmCubit>(
    () => PrayerAlarmCubit(
