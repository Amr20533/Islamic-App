...
import '../default/app_text_button.dart';

class ForgotAndRememberUser extends StatelessWidget {
  const ForgotAndRememberUser({
    super.key,
  });
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text("تذكرني", style: AppTextStyles.textTheme.labelMedium!.copyWith(fontSize: 12, color: AppColors.primaryColor),),
          ],
        ),
