...
import 'package:islamic_app/widgets/home/card_placeholder.dart';
import 'package:islamic_app/widgets/home/time_info.dart';

import '../../services/helpers/ramadan_service.dart';
...
class _IftarCountdownCardState extends State<IftarCountdownCard> {
  ...
  Widget build(BuildContext context) {
    ...
    double progress = 1.0 - (remainingSeconds / totalFastingDuration).clamp(0.0, 1.0);
