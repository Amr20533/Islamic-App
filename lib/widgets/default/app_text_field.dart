    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: AppTextStyles.textTheme.labelSmall!.copyWith(color: AppColors.hintTextColor, fontSize: 12),
          filled: true,
          fillColor: AppColors.creamOverlay, // 60% Cream #F7F3EE99
          // Prefix Icon (Right side in RTL)
          prefixIcon: Padding(
            padding: const EdgeInsets.all(9), // Adjust padding to center the icon
