  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          border: !isLast ? Border(bottom: BorderSide(width: 1, color: AppColors.borderColor)) : const Border()
      ),
      child: Row(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                surahModel.name,
                style: AppTextStyles.textTheme.titleLarge!.copyWith(color: AppColors.thirdTextColor),
              ),
              ...
              Row(
                children: [
                  Text(
                    "${surahModel.number}",
                    style: AppTextStyles.textTheme.labelMedium!.copyWith(color: AppColors.hintTextColor),
                  ),
                  Padding(
